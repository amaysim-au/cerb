...
define('CURL_DEBUG_PATH','/var/log/php-fpm/5.6/php_curl_debug.log');  // Location must be writable by ngnix user. Set value to '' (empty string) to disable or /var/log/php-fpm/5.6/php_curl_debug.log to enable and set log file path
